# 🚀 React Native Challenge - Juan Ordosgoite - Iskay Pets
...
1. Clone this repo, `git clone https://github.com/jordosgoite/joiskaypet.git`
2. Go to project's root directory, `cd joiskaypet`
